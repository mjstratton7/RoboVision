...
extern "C" {
   ...
   //------------------------------------------------------------------------------
   JNIEXPORT void JNICALL Java_com_qualcomm_fastcvdemo_apis_featureDetection_Corner_updateFastCv
   (
      JNIEnv*     env,
      jobject     obj,
      jbyteArray  img,
   ...
   JNIEXPORT jintArray JNICALL Java_com_qualcomm_fastcvdemo_apis_featureDetection_Corner_getCorners(JNIEnv*  env, jobject  obj);
};
