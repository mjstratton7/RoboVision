...
JNIEXPORT jboolean JNICALL Java_com_qualcomm_fastcvdemo_utils_FastCVSampleRenderer_drawPixel(
		JNIEnv* env, jobject obj, jint x, jint y, jint color1, jint color2);

JNIEXPORT jboolean JNICALL Java_com_qualcomm_fastcvdemo_utils_FastCVSampleRenderer_drawSquare(
...
//---------------------------------------------------------------------------
JNIEXPORT void JNICALL
Java_com_qualcomm_fastcvdemo_utils_FastCVSampleRenderer_render(JNIEnv * env,
...
Java_com_qualcomm_fastcvdemo_utils_FastCVSampleRenderer_getGPUFPS(JNIEnv* env,
		jobject obj);
