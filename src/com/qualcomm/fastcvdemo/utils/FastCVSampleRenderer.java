 ...
 * 
 */
public class FastCVSampleRenderer implements GLSurfaceView.Renderer, EGLContextFactory {
   ...
   public native boolean drawPixel(int x, int y, int color1, int color2);
   
   public native boolean drawSquare(int xMin, int xMax, int yMin, int yMax, int color1, int color2);
