...
public abstract class GraphicalActivity extends AbstractAdkActivity {
   /** Logging tag */
   ...
   protected final int                   mTextColor        = 0xF0000000; // ARGB
    ...
    * 
    */
   protected final Camera.PreviewCallback mCameraCallback = new Camera.PreviewCallback() {
      /**
   ...
   protected Runnable mUpdateTimeTask = new Runnable() {
       ...
       *  the fps and number of corners detected for the user */
	   ...
	   public void run()  {
         ...
         mText[1].setText ( 
             String.format( "Process Delay: %.2fms", mProcessTime ) 
         );
...
//         }
   ...
   protected void onResume() {
      ...
      screenw = ( (WindowManager)this.getSystemService( Context.WINDOW_SERVICE ) ).getDefaultDisplay().getWidth();
